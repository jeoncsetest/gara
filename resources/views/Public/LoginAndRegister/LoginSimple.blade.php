              ...
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  <div class="modal-header">
                    <h3 class="modal-title" id="exampleModalLabel">Modalità di accesso</h5>
                  <!--  <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                      <span aria-hidden="true">&times;</span> </button>-->
                  </div>
                  <div class="modal-body" text ="align-center">
                  <span>
                  <h3 text ="align-center">Come vuoi Iscriverti?</h1>
                  <br>
                  <a href="{{route('showSignupSimple', array('signupType'=>'TICKET'))}}" class="btn btn-secondary" role="button" aria-pressed="true">Pubblico</a>
                  <a href="{{route('showSignupSimple', array('signupType'=>'STUDENT'))}}" class="btn btn-secondary" role="button" aria-pressed="true">Ballerino</a>
                  <a href="{{route('showSignupSimple', array('signupType'=>'SCHOOL'))}}" class="btn btn-secondary" role="button" aria-pressed="true">Scuola</a>

                  </span>
                  </div>
                  <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">{{trans("Competition.close")}}</button>
                    <button type="button" class="btn btn-secondary" id="remove_cart_item" data-dismiss="modal" >{{trans("Competition.confirm")}}</button>
                  </div>
                </div>
              </div>
            </div>
