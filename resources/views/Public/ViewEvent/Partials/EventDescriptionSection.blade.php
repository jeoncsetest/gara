...
-->
       ...
       <!--
                    <a
                                            href="{{route('showAgreement', ['event_id'=>$event->id])}}"
                                            >@lang("ManageEvent.download_pdf_ticket")</a>      -->
