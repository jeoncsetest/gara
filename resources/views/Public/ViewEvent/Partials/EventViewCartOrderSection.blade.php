    ...
    <div class="row">
        <div class="col-md-12 order_header">
            ...
            <h2>
                ...
                <a class="competition_download_link"
                   href="{{ route('showOrderTickets', ['order_reference' => $order->order_reference] ).'?download=1' }}">
                    {{ @trans("Public_ViewEvent.competitions") }}</a> {{ @trans("Public_ViewEvent.confirmation_email") }}
            </h2>
        </div>
    </div>
                ...
                <div class="table-responsive">
                    <table class="table table-hover">
                        <thead>
                            <tr>
                                <th>
                                    @lang("Public_ViewEvent.competition")
                                </th>
                                <th>
