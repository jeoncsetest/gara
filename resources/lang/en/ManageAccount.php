...
return array (
  ...
  'licence_info_description' => 'Dancepass is licenced under the <b><a target="_blank" href="https://tldrlegal.com/license/attribution-assurance-license-(aal)#summary">Attribution Assurance Licence (AAL)</a></b>. This licence requires the <b>\'Powered By Dancepass\'</b> notice to be kept in place on any Dancepass installation. If you wish to remove references to Dancepass you must purchase one of the white-label licences <b><a target="_blank" href="https://attendize.com/license.html">listed here</a></b>.',
  ...
  'open_source_soft_description' => 'Dancepass is built using many fantastic open-source libraries. You can see an overview of these on <b><a href="https://libraries.io/github/Attendize/Attendize?ref=Attendize_About_Page" target="_blank">libraries.io</a></b>.',
  'payment' => 'Payment',
  ...
  'version_out_of_date' => 'Your version (<b>:installed</b>) of Dancepass is out of date. The latest version (<b>:latest</b>) can be <a href=":url" target="_blank">downloaded here</a>',
  'version_up_to_date' => 'Your Dancepass version (<b>:installed</b>) is up to date!',
